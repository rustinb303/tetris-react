"""Simplified demo script for the CrewAI multi-agent system with mock database integration."""
import os
import sys
...
def run_simplified_demo(topic="AI trends"):
    """
    Run a simplified demo with agents that can access and manipulate data in a mock database.
    ...
    print(f"Running simplified data integration demo with topic: {topic}")
    ...
    research_task = Task(
        ...
        To store your findings, use the MockDatabaseTool with the following format:
    ...
    analysis_task = Task(
        ...
        To retrieve the data, use the MockDatabaseTool with the following format:
        ```
        Action: MockDatabaseTool
