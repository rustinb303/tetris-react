"""Final demo script with simplified database integration for CrewAI agents."""
import os
import sys
...
class SimpleDatabaseTool(BaseTool):
    ...
    def __init__(self, table_name: str):
        ...
        super().__init__(
            name="SimpleDatabaseTool",
            description=f"Tool for reading and writing data to the {table_name} table in a simple database."
        )
