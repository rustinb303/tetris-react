"""Simple demo script with natural language database integration for CrewAI agents."""
import os
import sys
import json
import re
...
def run_simple_demo(topic="AI trends"):
    """
    ...
    print(f"Running simple demo with topic: {topic}")
    
    print("Setting up simple database...")
    db_tool = SimpleDBTool(table_name="research_data")
    ...
    research_task = Task(
        ...
        To store your findings, use the SimpleDBTool with natural language queries like:
    ...
    analysis_task = Task(
        ...
        To retrieve the data, use the SimpleDBTool with natural language queries like:
        ```
        Action: SimpleDBTool
